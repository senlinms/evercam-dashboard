    ...
    if type is "url"
      ...
      return "<a class='archive-actions dropdown-toggle archive-title' href='#'' title='share' data-id='#{id}' data-type='#{type}' data-toggle='modal' data-target='#modal-archive-info'><i class='fas fa-share-alt'></i> Share</a>" +
        ...
        "<ul class='dropdown-menu'>
          <li><a class='download-animation archive-icon' href='javascript:;' data-from='#{from_dt}' data-to='#{to_dt}' data-download-target='#gif-#{id}' title='Download GIF'><i class='fa fa-download'></i> GIF</a></li>" +
          "<li><a class='download-animation archive-icon' href='javascript:;' data-from='#{from_dt}' data-to='#{to_dt}' data-download-target='#mp4-#{id}' title='Download MP4'><i class='fa fa-download'></i> MP4</a></li></ul>" +
        "</div>" + div.html()
    else
